package com.example.v7_tictactoe;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView playerTurnHint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerTurnHint = (TextView) findViewById(R.id.playerTurnHint);
    ...
    private boolean checkForWin() {
        ...
        // Check columns
        for (int i = 0; i < 3; i++) if (field[0][i].equals(field[1][i]) && field[0][i].equals(field[2][i]) && !field[0][i].equals("")) return true;
    ...
    private void setPlayersTurn(boolean isPlayer1Turn) {
        player1Turn = isPlayer1Turn;

        String hintText = (player1Turn ? "Player 1" : "Player 2") + "'s turn!";

        playerTurnHint.setText(hintText);
    }
